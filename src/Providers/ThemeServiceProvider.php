...
class ThemeServiceProvider extends ServiceProvider
{
    ...
    {
        $enabledOverrides = explode(", ", $config->get("Mogli5.templates.override"));
        ...
        if (in_array("add_style", $enabledOverrides) || in_array("all", $enabledOverrides)) {
            ...
            $dispatcher->listen('IO.Resources.Import', function (ResourceContainer $container) {
                ...
                $container->addStyleTemplate('Mogli5::AddStyle');
            }, self::PRIORITY);
        ...
        if (in_array("add_script", $enabledOverrides) || in_array("all", $enabledOverrides)) {
            ...
            $dispatcher->listen('IO.Resources.Import', function (ResourceContainer $container)
            {
                ...
                $container->addScriptTemplate('Mogli5::AddScript');
            }, self::PRIORITY);
        ...
        $dispatcher->listen('IO.init.templates', function (Partial $partial) use ($enabledOverrides)
        {
            ...
            {
                $partial->set('head', 'Mogli5::PageDesign.Partials.Head');
            }
            if (in_array("header", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('header', 'Mogli5::PageDesign.Partials.Header.Header');
            }
            if (in_array("page_design", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('page-design', 'Mogli5::PageDesign.PageDesign');
            }
            if (in_array("footer", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('footer', 'Mogli5::PageDesign.Partials.Footer');
            }
            return false;
        }, self::PRIORITY);
        // Override homepage
        if (in_array("homepage", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Homepage.Homepage');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_content", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Category.Content.CategoryContent');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_view", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Category.Item.CategoryItem');
                return false;
            }, self::PRIORITY);
        }
        // Override item card
        $dispatcher->listen("IO.Resources.Import", function(ResourceContainer $container)
        {
            $container->addScriptTemplate('Mogli5::ItemList.Components.CategoryItem');
        },0);
        ...
        if (in_array("basket", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Basket.Basket');
                return false;
            }, self::PRIORITY);
        }
        // Override checkout
        if (in_array("checkout", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Checkout.Checkout');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Checkout.OrderConfirmation');
                return false;
            }, self::PRIORITY);
        }
        // Override login page
        if (in_array("login", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Customer.Login');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("register", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Customer.Register');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Item.SingleItemWrapper');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("search", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::ItemList.ItemListView');
                return false;
            }, self::PRIORITY);
        }
        // Override my account
        if (in_array("my_account", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::MyAccount.MyAccount');
                return false;
            }, self::PRIORITY);
        }
        // Override wish list
        if (in_array("wish_list", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::WishList.WishListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("contact", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Customer.Contact');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::OrderReturn.OrderReturnView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::OrderReturn.OrderReturnConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_rights", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::StaticPages.CancellationRights');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_form", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::StaticPages.CancellationForm');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("legal_disclosure", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::StaticPages.LegalDisclosure');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("privacy_policy", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::StaticPages.PrivacyPolicy');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("terms_conditions", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::StaticPages.TermsAndConditions');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::StaticPages.ItemNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("page_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::StaticPages.PageNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("newsletter_opt_out", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Mogli5::Newsletter.NewsletterOptOut');
                return false;
            }, self::PRIORITY);
        }

        $enabledResultFields = explode(", ", $config->get("Mogli5.result_fields.override"));
        ...
        if (in_array("auto_complete_list_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
            ...
            {
                $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_AUTOCOMPLETE_ITEM_LIST, 'Mogli5::ResultFields.AutoCompleteListItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("basket_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
            ...
            {
                $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_BASKET_ITEM, 'Mogli5::ResultFields.BasketItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_tree", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
            ...
            {
                $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_CATEGORY_TREE, 'Mogli5::ResultFields.CategoryTree');
                return false;
            }, self::PRIORITY);
        }
        ...
        {
            $resultFieldTemplate->setTemplate(ResultFieldTemplate::TEMPLATE_LIST_ITEM, 'Mogli5::ResultFields.ListItem');
        }
        ...
        if (in_array("single_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
            ...
            {
                $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_SINGLE_ITEM, 'Mogli5::ResultFields.SingleItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        $dispatcher->listen('IO.Component.Import', function (ComponentContainer $container)
        {
            ...
            {
                $container->setNewComponentTemplate('Mogli5::Customer.Components.UserLoginHandler');
            }
        }, self::PRIORITY);
